...
$(function () {
	...
	$("#menu-switch").click(function(){alert(1);
		parent.document.getElementsByTagName('frameset')[1].cols=(parent.document.getElementsByTagName('frameset')[1].cols=='10,*')?'196,*':'10,*';
		parent.leftFrame.document.getElementById('menus').style.display=(parent.leftFrame.document.getElementById('menus').style.display=='none')?'block':'none';
	});
