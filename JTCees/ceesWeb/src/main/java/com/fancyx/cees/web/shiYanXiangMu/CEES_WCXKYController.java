...
public class CEES_WCXKYController {
    ...
    private static final Logger log = Logger.getLogger(CEES_WCXKYController.class);

    @Resource
    private CEES_WCXKYService cees;

    @Resource
    private Display_WCXKYService diplay;
    ...
    @ResponseBody
    public PageResultBean search(CEES_WCXKYVo vo,
                                 @RequestParam(value = "page", required = false, defaultValue = "1") int page,
                                 @RequestParam(value = "limit", required = false, defaultValue = "10") int pageSize) {

        try {
            PageBean pageBean = new PageBean<CEES_WCXKY>(page, pageSize);
            PageBean<CEES_WCXKY> result = cees.pageQuery(pageBean, vo);
    ...
    @ResponseBody
    public ResultBean update(CEES_WCXKYVo vo) {
    ...
    @ResponseBody
    public ResultBean add(HttpSession session, CEES_WCXKYVo vo) {
        ...
        try {
            ...
            //
            vo.setWcxnumber(dbUtil.getWcxnumber());
            //client
